const mockCardsData = require("@repo/testing-fixtures/nrdb/cards.json");
const mockPackData = require("@repo/testing-fixtures/api/packs.json");
const testCardsData = require("@repo/testing-fixtures/nrdb/cards-agendas.json");
const advancementCostTestCardsData = require("@repo/testing-fixtures/nrdb/cards-agendas.json");
const strengthTestCardsData = require("@repo/testing-fixtures/nrdb/cards-strength.json");
const subroutinesTestCardsData = require("@repo/testing-fixtures/nrdb/cards-subroutines.json");
const officialCardsData = require("@repo/testing-fixtures/nrdb/cards-official.json");
const bannedData = require("@repo/testing-fixtures/nrdb/banned.json");
...
describe("process cards", () => {
  ...
  it("does not output cards for not included packs", () => {
    const output = process(mockCardsData, mockPackData, bannedData);
    const cards = output.find(
      (card) => card.title === "The Shadow: Pulling the Strings"
    );
