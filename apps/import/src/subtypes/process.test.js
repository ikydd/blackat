const mockData = require("@repo/testing-fixtures/api/subtypes-cards.json");
const mockDataSides = require("@repo/testing-fixtures/api/subtypes-cards-sides.json");
const mockDataDualSide = require("@repo/testing-fixtures/api/subtypes-cards-dualside.json");
