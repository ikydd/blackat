...
import options from "@repo/testing-fixtures/api/foo-nested.json";
import singleOptions from "@repo/testing-fixtures/api/foo-nested-single.json";
import groupOptions from "@repo/testing-fixtures/api/foo-nested-group.json";
  ...
  describe("Options", () => {
    ...
    it("calls the callback when the group is checked", async () => {
      ...
      const { findByLabelText } = render(
        <NestedFilterList options={options} onChange={groupCb} />
      );
    ...
    it("calls the callback when an item is checked", async () => {
      const cb = jest.fn();
      const { findByLabelText } = render(
        <NestedFilterList options={options} onChange={cb} />
      );
